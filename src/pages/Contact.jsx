            ...
            <div className={`transition-colors duration-500 ease-in-out min-h-screen ${isDarkMode ? 'bg-black text-white' : 'bg-white text-black'}`}>
                <div className="flex flex-col md:flex-row p-6" data-aos="zoom-in" data-aos-duration="800">
                    <div className="md:w-1/2 flex flex-col items-center p-4">
                        ...
                        <h2 className={`mt-4 text-2xl font-bold ${isDarkMode ? 'text-white' : 'text-black'}`}>Isaac Ramírez</h2>
                        <p className={`${isDarkMode ? 'text-white' : 'text-black'}`}>Software Engineer</p>
                    </div>
                    <div className="md:w-1/2 p-4">
                        <h2 className={`text-xl font-bold ${isDarkMode ? 'text-white' : 'text-black'}`}>Contact</h2>
                        <div className="mt-4">
                            <p><span className="font-bold">Email:</span> <span className={`${isDarkMode ? 'text-white' : 'text-black'}`}>izackk26@gmail.com</span></p>
                            <p><span className="font-bold">Institution:</span> <span className={`${isDarkMode ? 'text-white' : 'text-black'}`}>Tecnológico de Costa Rica</span></p>
                            <p><span className="font-bold">Country:</span> <span className={`${isDarkMode ? 'text-white' : 'text-black'}`}>Costa Rica</span></p>
                        </div>
                        <div className='pt-3'>
                            <a
                                href="cv.pdf"
